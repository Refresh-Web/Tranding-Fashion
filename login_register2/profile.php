            ...
            <form action="" method="post">
                ...
                <div class="profile_form">
                    ...
                    <div class="p_zipcode">
                        ...
                        <input type="text" id="zipcode" name="zipcode" placeholder="Enter your zip/post code" autocomplete="off">
                    </div>
                    ...
                    <div class="p_number">
                        ...
                        <input type="text" id="number" name="number" placeholder="Enter your modile number" autocomplete="off">
                    </div>
